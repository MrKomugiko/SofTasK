...
namespace SofTasK.API.Migrations
{
    ...
    [Migration("20220617215749_joinrequests")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SofTasK.API.Models.JoinRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SofTasK.API.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SofTasK.API.Models.JoinRequest", b =>
                {
                    ...
                    b.HasOne("SofTasK.API.Models.AppUser", "User")
                        .WithMany("JoinRequests")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
